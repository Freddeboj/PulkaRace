...
namespace Coherence.Generated
{
	...
	public struct WorldPosition : ICoherenceComponentData
	{
		...
		public static (WorldPosition, uint, uint?) DeserializeArchetype__char_91_Player__char_93__7f974e5226933614abe6e75b3eb39f5a_WorldPosition_LOD0(InProtocolBitStream bitStream)
		{
			var mask = (uint)0;
			var val = new WorldPosition();
			if (bitStream.ReadMask())
